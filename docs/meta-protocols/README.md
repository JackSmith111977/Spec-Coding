...
- Environment Discover：当前 Runtime / Project / Existing Harness 实际提供什么；
- Harness Adapt：如何用当前能力承载每条 Clause；
...
Adoption Baseline、Semantic IR、Environment Model 与 Harness 各自承担不同生命周期，不互相复制为平行事实源。
