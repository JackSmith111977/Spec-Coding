...
Workflow 继续决定产物内容、必需字段、状态、Gate 与关闭条件；[项目接入](../skills/spec-project-onboarding/SKILL.md)负责建立、复用和迁移稳定位置与共享边界；[Harness 接入](../skills/spec-harness-adoption/SKILL.md)负责真实加载、适配和验收。目录与索引不能成为第二套业务事实源。
